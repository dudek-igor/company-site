...
export default function ContactSectionBackground({ className }: TMap) {
  return (
    <>
      <svg
        ...
        width="1296px"
        height="533px"
        viewBox="0 0 1296 533"
        enableBackground="new 0 0 1296 533"
        xmlSpace="preserve"
      >
        <image
          id="image0"
          ...
          x="0"
          y="0"
          xlinkHref="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAABRAAAAIVCAQAAAAD/xsyAAAABGdBTUEAALGPC/xhBQAAACBjSFJN
